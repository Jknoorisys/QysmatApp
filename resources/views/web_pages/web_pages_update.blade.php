<div class="card">
    <div class="card-body">
        <form class="form-horizontal form-material" action="{{route('updateWebPageFun')}}" method="post" id="add_contact">
            @csrf
            ...
            {{-- <div class="row"> --}}
                <div class="col-md-12">
                    ...
                    <div class="input-group">
                        <input type="text" readonly value="{{$records->page_name}}" class="form-control smp-input" style="font-weight: 300;font-size: 15px;color: #38424C;" name="page_name" id="page_name" placeholder="{{ __('msg.Enter Web Page Name')}}">
                    </div>
                ...
                <div class="col-md-12 mt-4">
                    ...
                    <div class="input-group">
                        <input type="text" value="{{$records->page_title}}" class="form-control smp-input" style="font-weight: 300;font-size: 15px;color: #38424C;" name="page_title" id="page_title" placeholder="{{ __('msg.Enter Web Page Title')}}">
                    </div>
