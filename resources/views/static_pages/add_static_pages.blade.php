<div class="card">
    <div class="card-body">
        <form class="form-horizontal form-material" action="{{route('addPageFun')}}" method="post" id="add_contact">
            @csrf
            {{-- <div class="row"> --}}
                <div class="col-md-12">
                    <label for="page_name" class="form-label">{{__('msg.Page Name')}}</label>
                    <div class="input-group">
                        <input type="text" class="form-control smp-input" style="font-weight: 300;font-size: 15px;color: #38424C;" name="page_name" id="page_name" placeholder="{{ __('msg.Enter Page Name')}}">
                    </div>
                ...
                <div class="col-md-12 mt-4">
                    ...
                    <div class="input-group">
                        <input type="text" class="form-control smp-input" style="font-weight: 300;font-size: 15px;color: #38424C;" name="page_title" id="page_title" placeholder="{{ __('msg.Enter Page Title')}}">
                    </div>
                ...
                <div class="col-md-12 mt-4">
                    ...
                    <div class="input-group">
                        <textarea id="description" name="description" rows="10" placeholder="{{ __('msg.Enter Page Description')}}" data-sample="2" data-sample-short></textarea>
                    </div>
