<div class="card">
    <div class="card-body">
        <form class="form-horizontal form-material" action="{{route('addContactFun')}}" method="post" id="add_contact">
            @csrf
            {{-- <div class="row"> --}}
                <div class="col-md-12">
                    <label for="contact_type" class="form-label">{{__('msg.Contact Type')}}</label>
                    <div class="input-group">
                        <input type="text" class="form-control smp-input" style="font-weight: 300;font-size: 15px;color: #38424C;" name="contact_type" id="contact_type" placeholder="{{ __('msg.Enter Contact Type')}}">
                    </div>
