                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-2 mt-1">
                                                <form action="{{route('changeQuoteStatus')}}" method="post" class="text-center">
                                                    ...
                                                    <button type="submit" data-status="{{$value->status == 'Active' ? 'Active' : 'Inactive'}}" data-id="{{$value->id}}" data-name="{{__('msg.Islamic Quote')}}" class="btn block_confirm btn-sm"><input type="checkbox" id="switch" {{$value->status == 'Inactive' ? '' : 'checked'}} /><label for="switch">Toggle</label></button>
                                                </form>
                                            </div>
                                            <div class="col-2">
