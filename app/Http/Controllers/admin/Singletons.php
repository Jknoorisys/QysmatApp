    ...
    public function viewSingleton(Request $request)
    {
        ...
        if(!empty($id)){
            ...
            if ($data['details']->subscription_type == 'Basic') {
                ...
                $features = [__("msg.Unlimited swipes per day"), __("msg.Send instant match requestweek)"), __("msg.In-app telephone and video calls"), __("msg.Refer profiles to friends and family"), __("msg.Undo last swipe"), __("msg.Reset profile search and start again once a month")];
            }
